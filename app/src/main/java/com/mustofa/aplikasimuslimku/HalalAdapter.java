...
public class HalalAdapter extends RecyclerView.Adapter<HalalAdapter.ViewHolder>{
    ...
    private List<DataHalalku> dataHalal;

    HalalAdapter(Context context, List<DataHalalku> dataHalal) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.produk_halalku, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(ViewHolder holder, int position) {
        final DataHalalku halal = dataHalal.get(position);
